...
export const en = {
  ...
  auth: {
    ...
    acceptTermsLead: 'I have read and accept the',
    acceptTermsTermsLink: 'Terms of Service',
    acceptTermsMid: 'and the',
    acceptTermsPrivacyLink: 'Privacy Policy',
    acceptTermsCheckboxAria: 'I accept the Terms of Service and Privacy Policy',
    errorTermsRequired: 'You must accept the Terms of Service and Privacy Policy to create an account.',
    legalModalCloseAria: 'Close legal document',
    googleDisabledNeedTerms: 'Accept the Terms and Privacy Policy to continue with Google',
  },
  landing: {
    navProduct: 'Product',
