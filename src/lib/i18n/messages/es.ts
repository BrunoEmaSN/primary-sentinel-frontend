...
export const es = {
  ...
  auth: {
    ...
    forgotSubtitle: 'Te enviaremos un enlace por correo para elegir una nueva contraseña',
    forgotSubmit: 'Enviar enlace',
    forgotBackToLogin: 'Volver a iniciar sesión',
    forgotEmailSent:
      'Si el correo está registrado, te enviamos un enlace para restablecer la contraseña. Revisá tu bandeja de entrada.',
    newPasswordLabel: 'NUEVA CONTRASEÑA',
    confirmPasswordLabel: 'CONFIRMAR CONTRASEÑA',
    resetPasswordTitle: 'NUEVA CONTRASEÑA',
    resetPasswordSubtitle: 'Elegí una contraseña segura para tu cuenta',
    resetPasswordSubmit: 'Actualizar contraseña',
    resetPasswordMismatch: 'Las contraseñas no coinciden.',
    resetPasswordNoSession: 'El enlace no es válido o expiró. Pedí un nuevo enlace de restablecimiento.',
    resetPasswordSuccess: 'Contraseña actualizada. Redirigiendo…',
    resetPasswordErrorWeak: 'La contraseña debe tener al menos 6 caracteres.',
    errorPasswordRequired: 'Ingresá una contraseña.',
    requestNewResetLink: 'Pedir otro enlace',
    acceptTermsLead: 'Leí y acepto los',
    acceptTermsTermsLink: 'Términos del servicio',
    acceptTermsMid: 'y la',
    acceptTermsPrivacyLink: 'Política de privacidad',
    acceptTermsCheckboxAria: 'Acepto los Términos del servicio y la Política de privacidad',
    errorTermsRequired: 'Tenés que aceptar los Términos del servicio y la Política de privacidad para crear una cuenta.',
    legalModalCloseAria: 'Cerrar documento legal',
    googleDisabledNeedTerms: 'Aceptá los Términos y la Política de privacidad para continuar con Google',
  },
  landing: {
    navProduct: 'Producto',
